...
const monthsData = [
  {
    ...
    daysCount: 31,
    topics: [
      { t: "Un nuevo comienzo", p: "2 Corintios 5:17", v: "De modo que si alguno está en Cristo, nueva criatura es; las cosas viejas pasaron; he aquí todas son hechas nuevas." },
      { t: "Planes de bien", p: "Jeremías 29:11", v: "Porque yo sé los pensamientos que tengo acerca de vosotros, dice Jehová, pensamientos de paz, y no de mal, para daros el fin que esperáis." },
      { t: "Caminar por fe", p: "2 Corintios 5:7", v: "Porque por fe andamos, no por vista." },
      { t: "La certeza de lo que se espera", p: "Hebreos 11:1", v: "Es, pues, la fe la certeza de lo que se espera, la convicción de lo que no se ve." },
      { t: "Nuevas misericordias", p: "Lamentaciones 3:22-23", v: "Por la misericordia de Jehová no hemos sido consumidos, porque nunca decayeron sus misericordias. Nuevas son cada mañana; grande es tu fidelidad." },
      { t: "Confianza total en Dios", p: "Proverbios 3:5-6", v: "Fíate de Jehová de todo tu corazón, y no te apoyes en tu propia prudencia. Reconócelo en todos tus caminos, y él enderezará tus veredas." },
      { t: "El Dios de lo imposible", p: "Lucas 1:37", v: "Porque nada hay imposible para Dios." },
      { t: "Fuerza en la debilidad", p: "Isaías 40:29", v: "Él da esfuerzo al cansado, y multiplica las fuerzas al que no tiene ningunas." },
      ...
      { t: "Luz en tu camino", p: "Salmos 119:105", v: "Lámpara es a mis pies tu palabra, y lumbrera a mi camino." },
      { t: "Sembrar con fe", p: "Gálatas 6:9", v: "No nos cansemos, pues, de hacer bien; porque a su tiempo segaremos, si no desmayamos." },
      { t: "Renovación de la mente", p: "Romanos 12:2", v: "No os conforméis a este siglo, sino transformaos por medio de la renovación de vuestro entendimiento." },
      { t: "Valentía y esfuerzo", p: "Josué 1:9", v: "Mira que te mando que te esfuerces y seas valiente; no temas ni desmayes, porque Jehová tu Dios estará contigo en dondequiera que vayas." },
      { t: "Buscar primeramente el Reino", p: "Mateo 6:33", v: "Mas buscad primeramente el reino de Dios y su justicia, y todas estas cosas os serán añadidas." },
      { t: "Dios suplirá todo", p: "Filipenses 4:19", v: "Mi Dios, pues, suplirá todo lo que os falta conforme a sus riquezas en gloria en Cristo Jesús." },
      { t: "El poder de la alabanza", p: "Salmos 34:1", v: "Bendeciré a Jehová en todo tiempo; su alabanza estará de continuo en mi boca." },
      { t: "Permanecer en la vid", p: "Juan 15:5", v: "Yo soy la vid, vosotros los pámpanos; el que permanece en mí, y yo en él, éste lleva mucho fruto." },
      { t: "El escudo de la fe", p: "Efesios 6:16", v: "Sobre todo, tomad el escudo de la fe, con que podáis apagar todos los dardos de fuego del maligno." },
      { t: "Refugio seguro", p: "Salmos 91:1-2", v: "El que habita al abrigo del Altísimo morará bajo la sombra del Omnipotente." },
      { t: "Paz en la tormenta", p: "Marcos 4:39", v: "Y levantándose, reprendió al viento, y dijo al mar: Calla, enmudece. Y cesó el viento, y se hizo grande bonanza." },
      { t: "Cosas grandes y ocultas", p: "Jeremías 33:3", v: "Clama a mí, y yo te responderé, y te enseñaré cosas grandes y ocultas que tú no conoces." },
      { t: "La alegría del Señor es tu fuerza", p: "Nehemías 8:10", v: "No os entristezcáis, porque el gozo de Jehová es vuestra fuerza." },
      { t: "Hijos de Dios", p: "1 Juan 3:1", v: "Mirad cuál amor nos ha dado el Padre, para que seamos llamados hijos de Dios." },
      { t: "Todo lo puedo en Cristo", p: "Filipenses 4:13", v: "Todo lo puedo en Cristo que me fortalece." },
      { t: "Gracia abundante", p: "2 Corintios 12:9", v: "Bástate mi gracia; porque mi poder se perfecciona en la debilidad." },
      { t: "Guarda tu corazón", p: "Proverbios 4:23", v: "Sobre toda cosa guardada, guarda tu corazón; porque de él mana la vida." },
      { t: "Dios pelea por ti", p: "Éxodo 14:14", v: "Jehová peleará por vosotros, y vosotros estaréis tranquilos." },
      { t: "La paciencia de la fe", p: "Santiago 1:3-4", v: "Sabiendo que la prueba de vuestra fe produce paciencia. Mas tenga la paciencia su obra completa." },
      { t: "La herencia del creyente", p: "Romanos 8:17", v: "Y si hijos, también herederos; herederos de Dios y coherederos con Cristo." },
      { t: "Caminar en amor", p: "Efesios 5:2", v: "Y andad en amor, como también Cristo nos amó, y se entregó a sí mismo por nosotros." },
      { t: "Mirando al autor de la fe", p: "Hebreos 12:2", v: "Puestos los ojos en Jesús, el autor y consumador de la fe." }
    ]
  },
  {
    month: 2,
    ...
    daysCount: 28,
    topics: [
      { t: "El verdadero amor", p: "1 Corintios 13:4-7", v: "El amor es sufrido, es benigno; el amor no tiene envidia, el amor no es jactancioso, no se envanece." },
      ...
      { t: "Perdonar setenta veces siete", p: "Mateo 18:21-22", v: "No te digo hasta siete, sino aun hasta setenta veces siete." },
  ...
  },
  {
    ...
    topics: [
      ...
      { t: "Trabajar para el Señor", p: "Colosenses 3:23-24", v: "Y todo lo que hagáis, hacedlo de corazón, como para el Señor y no para los hombres." },
      ...
      { t: "El trabajo honesto bendice", p: "1 Tesalonicenses 4:11-12", v: "Y que procuréis tener quietud, y hacer vuestros propios negocios, y trabajar con vuestras manos." },
  ...
  },
  {
    ...
    topics: [
      ...
      { t: "La roca inconmovible", p: "Mateo 7:24-25", v: "Cualquiera, pues, que me oye estas palabras, y las hace, le compararé a un hombre prudente, que edificó su casa sobre la roca." },
  ...
  },
  {
    ...
    topics: [
      ...
      { t: "Raíces profundas", p: "Colosenses 2:6-7", v: "Arraigados y sobreedificados en él, y confirmados en la fe, así como habéis sido enseñados." },
      ...
      { t: "La paciencia engendra carácter", p: "Romanos 5:3-4", v: "Y no sólo esto, sino que también nos gloriamos en las tribulaciones, sabiendo que la tribulación produce paciencia." },
  ...
  },
  {
    ...
    topics: [
      ...
      { t: "Dios te equipa para su obra", p: "Hebreos 13:20-21", v: "Os haga aptos en toda obra buena para que hagáis su voluntad, haciendo él en vosotros lo que es agradable delante de él." },
  ...
  },
  {
    ...
    topics: [
      ...
      { t: "El modelo de Jesús", p: "Mateo 6:9-13", v: "Vosotros, pues, oraréis así: Padre nuestro que estás en los cielos, santificado sea tu nombre. Venga tu reino." },
  ...
  },
  {
    ...
    topics: [
      ...
      { t: "La belleza de la santidad", p: "1 Pedro 1:15-16", v: "Sino, como aquel que os llamó es santo, sed también vosotros santos en toda vuestra manera de vivir." },
  ...
  },
  {
    ...
    daysCount: 31,
    topics: [
      { t: "Dios con nosotros: Enmanuel", p: "Mateo 1:23", v: "He aquí, una virgen concebirá y dará a luz un hijo, y llamarás su nombre Emanuel, que traducido es: Dios con nosotros." },
...
for (const m of monthsData) {
  for (let d = 1; d <= m.daysCount; d++) {
    ...
    const dev = {
      ...
      passage: topic.p,
      verse: topic.v,
      reflection: generateReflection(topic, m.theme, d, m.name),
      declaration: generateDeclaration(topic),
      prayerPrompt: generatePrayerPrompt(topic)
    };
